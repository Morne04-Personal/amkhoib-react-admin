...
export const Form4: React.FC<Form4Props> = ({ user, updateUser, disciplines, allowMultipleDisciplines, onSwitchToLink }) => {
      ...
      <Grid container spacing={2}>
        <Grid item xs={12}>
          <Box display="flex" justifyContent="flex-start">
            <ButtonShowHide text="Link Existing Construction Manager" icon={<LinkIcon />} onClick={onSwitchToLink} />
          </Box>
        </Grid>
        <Grid item xs={12}>
          <TextField
