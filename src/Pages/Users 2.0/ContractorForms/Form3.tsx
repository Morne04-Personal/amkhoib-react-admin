...
export const Form3: React.FC<Form3Props> = ({
  user,
  updateUser,
  disciplines,
  assignableCompanies,
  allowMultipleDisciplines,
  mainContractorType,
  onSwitchToLink,
}) => {
  ...
  console.log("Form3 - mainContractorType:", mainContractorType)
  console.log("Form3 - assignableCompanies:", assignableCompanies)
      ...
      <Grid container spacing={2}>
        <Grid item xs={12}>
          <Box display="flex" justifyContent="flex-start" mb={2}>
            <ButtonShowHide text="Link Existing Contractor" icon={<LinkIcon />} onClick={onSwitchToLink} />
          </Box>
        </Grid>
        <Grid item xs={12}>
          <TextField
